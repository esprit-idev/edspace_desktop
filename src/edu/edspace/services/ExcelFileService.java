    ...
    public void generateExcelStudent() 
      ...
      // PreparedStatement pst = MyConnection.getInstance().getCnx().prepareStatement(req);
           ...
           // header.createCell(5).setCellValue("Prix");
            ...
            FileOutputStream fileOut = new FileOutputStream("C:\\Users\\YOOSURF\\Desktop\\Liste_des_etudiants.Xls");
            wb.write(fileOut);
            fileOut.close();
           ste.close();
           rs.close();
          Desktop.getDesktop().open(new File("C:\\Users\\YOOSURF\\Desktop\\Liste_des_etudiants.Xls"));
    ...
    public void generateExcelAdmin() 
      ...
      // PreparedStatement pst = MyConnection.getInstance().getCnx().prepareStatement(req);
           ...
           // header.createCell(5).setCellValue("Prix");
            ...
            FileOutputStream fileOut = new FileOutputStream("C:\\Users\\YOOSURF\\Desktop\\liste_des_administrateurs.Xls");
            wb.write(fileOut);
            fileOut.close();
           ste.close();
           rs.close();
          Desktop.getDesktop().open(new File("C:\\Users\\YOOSURF\\Desktop\\liste_des_administrateurs.Xls"));
